    ...
    parallel 'connect': {
      node('docker') {
        ...
        print "Finished connect"
            ...
            '202207': {
              def image = buildImage(RSPVersion, '4.2.0', buildRRepo('2022-07-06+Y3JhbiwxMDo1MzA5LDk6OTk1ODk5Njs2NENBNUJERA'), latest: true, dockerfile: './multi.Dockerfile', rVersionAlt: '4.1.2', pyVersion: '3.10.4', pyVersionAlt: '3.9.6', rRepoAlt: buildRRepo('2021-11-12+MTc6NTg4NzczOSwxMDo1MzA5LDk6NTk2NTg0NTsyNENERDc2OQ'), tag: "${RSPSafeVersion}-202207", gossVars: 'goss_vars.yaml')
              print "Finished 202207"
            }
  }
  stage('finish') {
    node('docker') {
