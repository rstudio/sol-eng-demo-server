...
ansiColor('xterm') {
    ...
    stage('build') {
        parallel '2023.12.0-old-r-and-python': {
            def image = buildImage("2023.12.0-past-r-and-python", "3.5.3 3.6.3", "4.2.3", "3.7.16", "3.9.14")
            print "Finished 2023.09.1-old-r-and-python"
        },
        '2023.12.0-default': {
            def image = buildImage("2023.12.0-default", "4.0.5 4.1.3", "4.2.3", "3.10.11", "3.10.11")
            print "Finished 2023.12.0-default"
        }
    }
    stage('finish') {
        node('docker') {
